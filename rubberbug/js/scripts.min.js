  ...
  var actions = {
    ...
    openCart: function() {
      var subtotal = 0,
			cartHtml = '';
      cartData = actions.getStorage();
      orderPreview = '<p class="jqcart-cart-title">Корзина <span class="jqcart-print-order"></span></p><div class="jqcart-table-wrapper"><div class="jqcart-manage-order"><div class="jqcart-thead"><div class="hidden">ID</div><div></div><div>Назва</div><div>Ціна</div><div class="hidden-xs">К-сть</div><div>Сумма</div><div></div></div>';
      var key, sum = 0;
      for (key in cartData) {
        if (cartData.hasOwnProperty(key)) {
          ...
          orderPreview += '<div  class="jqcart-tr" data-id="' + cartData[key].id + '">';
					orderPreview += '<div  class="jqcart-small-td hidden">' + cartData[key].id + '</div>';
          ...
          orderPreview += '<div class="hidden-xs"><span class="jqcart-incr" data-incr="-1">&#8211;</span><input type="text" class="jqcart-amount" value="' + cartData[key].count + '"><span class="jqcart-incr" data-incr="1">+</span></div>';
      ...
      orderPreview += '<div class="jqcart-subtotal">Всього: <strong>' + subtotal + '</strong> ' + opts.currency + '</div>';
    ...
    sendOrder: function(e) {
      ...
      if ($.trim($('[name=user_name]', $that).val()) === '' || $.trim($('[name=user_phone]', $that).val()) === '') {
        $('<p class="jqcart-error">Будь-ласка, вкажіть своє імя та контактний телефон!</p>').insertBefore($that).delay(3000).fadeOut();
        return false;
      }
      $.ajax({
        url: opts.handler,
		...
		printOrder: function (){
			...
			var win = window.open('', 'Друк замовлення', 'width='+screen.width+',height='+screen.height),
			...
			win.document.write('<html><head><title>Замовлення ' + curDate + '</title>');
...
$(function(){function e(){$(".carousel-services-item").each(function(){var e=$(this),a=e.find(".carousel-services-content").outerHeight();e.find(".carousel-services-image").css("min-height",a)})}$(".gallery-wrap .gall-item img").each(function(){var e=$(this).attr("src");$(this).wrap('<a class="img-wrap" href=""></a>'),$(this).parent("a").attr("href",e)}),$(".item-buy").each(function(e){var a=$(this),i=a.siblings(".item-cover").children("img").attr("src"),t=a.siblings(".item-name").text(),s=a.siblings(".item-price").text();a.data("id",e),a.data("img",i),a.data("title",t),a.data("price",parseInt(s))}),$.jqCart({buttons:".item-buy",handler:"handler.php",visibleLabel:!1,openByAdding:!1,currency:"grn;",cartLabel:".label-place"}),$.jqCart("openCart"),$.jqCart("clearCart"),$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/imagelogo.png" alt="Rubber bag">'},offCanvas:{position:"right"},pageScroll:{scroll:"true",update:"true"},scrollBugFix:{fix:!0}});var a=$("#my-menu").data("mmenu");a.bind("open:start",function(){$(".hamburger").addClass("is-active")}),a.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-service-composition h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),$(".carousel-services").owlCarousel({loop:!0,nav:!0,smartSpeed:700,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}).on("changed.owl.carousel",function(){e()}),e(),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1}),$(".partners").owlCarousel({loop:!0,smartSpeed:700,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],nav:!0,responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:3}}}),$("select").selectize({create:!0,sortField:"text"}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(window).scroll(function(){$(this).scrollTop()>$(window).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},1e3)}),!1})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow"),$(".gall-item a").magnificPopup({type:"image",gallery:{enabled:!0}})});