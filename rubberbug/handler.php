...
// ваш Email
$admin_mail = 'igor.khatsko87@gmail.com';
...
$headers[] = 'From: Best Shop <igor.khatsko87@gmail.com>'; // От кого
...
$response = [
	'errors' => !$send_ok,
	'message' => $send_ok ? 'Заявка обробляється! Дякуємо' : 'Хьюстон! У нас проблемы!'
];
